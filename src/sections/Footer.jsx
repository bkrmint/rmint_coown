...
import { copyright_sign, facebook, instagram, twitter } from "../assets/icons";

const Footer = () => {
  return (
    <footer className="max-container">
      <div className="flex justify-center items-center gap-20">
        <img src={footer_logo} alt="footer_logo" width={130}  />
      </div>
      <div className="flex justify-center gap-5 mt-8 mb-8 ">
        ...
        <div className="flex bg-white w-10 h-10 rounded-full justify-center items-center">
          <img src={twitter} alt="facebook" width={20} height={20} />
        </div>
      </div>
      ...
      <p className="flex flex-1 justify-start items-center gap-2 font-publicsans mt-2">
        Terms & Conditions
      </p>
